...
class MenuWithIcons extends Menu
{
    ...
    public $linkTemplateWithIconParent ='<a href="{url}"><i class="fa fa-fw {icon}"></i> <span class="menu-item-parent">{label}</span>{badge}</a>' ;
    public $linkTemplateWithOutIconParent ='<a href="{url}"><span class="menu-item-parent">{label}</span>{badge}</a>' ;
    ...
    protected function renderItem($item)
    {
        ...
        if (!isset($item['icon'])) {
            ...
            return strtr($template, [
                ...
                '{label}' => $item['label'],
                '{badge}' => isset($item['badge']) ? $this->badge : '',
            ]);
    ...
    public function run() {
        $this->badge = Html::tag('span', '', ['class' => 'fa arrow']);
